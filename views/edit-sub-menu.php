...
if(!isset($_GET['p'])){
  ...
  $_SESSION["project_cv_aquila_indonesia"]["name_page"] = "Ubah Sub Menu";
  ...
  <div class="page-header">
    <div class="page-header-left d-flex align-items-center">
      ...
      <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item"><?= $_SESSION['project_cv_aquila_indonesia']['name_page'].' '.$data_sub_menu['title'] ?>
        </li>
      </ul>
    </div>
  </div>
