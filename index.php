...
<!-- Mirrored from wphix.com/template/puik-prev/puik/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Oct 2024 15:43:25 GMT -->
<head>
  <meta charset="utf-8">
  ...
  <link rel="shortcut icon" type="image/x-icon" href="assets/ui/img/favicon.ico">
  <!-- Place favicon.ico in the root directory -->

  <!-- CSS here -->
  <link rel="stylesheet" href="assets/ui/css/preloader.css">
  <link rel="stylesheet" href="assets/ui/css/owl.carousel.min.css">
  <link rel="stylesheet" href="assets/ui/css/animate.min.css">
  <link rel="stylesheet" href="assets/ui/css/magnific-popup.css">
  <link rel="stylesheet" href="assets/ui/css/meanmenu.css">
  <link rel="stylesheet" href="assets/ui/css/animate.min.css">
  <link rel="stylesheet" href="assets/ui/css/slick.css">
  <link rel="stylesheet" href="assets/ui/css/bootstrap.min.css">
  <link rel="stylesheet" href="assets/ui/css/fontawesome-all.min.css">
  <link rel="stylesheet" href="assets/ui/css/themify-icons.css">
  <link rel="stylesheet" href="assets/ui/css/nice-select.css">
  <link rel="stylesheet" href="assets/ui/css/ui-range-slider.css">
...
<body>
          ...
          <div class="col-xxl-3 col-xl-2 col-lg-2 col-md-4 col-sm-6 col-4">
            <div class="header-left">
              <div class="logo pr-55 d-inline-block">
                <a href="index-2.html"><img src="assets/ui/img/logo/logo-black.png" alt="#"></a>
              </div>
            </div>
          </div>
              ...
              <nav id="mobile-menu">
                <ul>
                  <li><a href="index-2.html">Home</a>
                    <ul class="sub-menu">
                      <li><a href="index-2.html">Home Layout 1</a>
                        <ul class="sub-menu">
                          <li><a href="index-2.html">Home Layout 1</a></li>
                          <li><a href="index-3.html">Home Layout 2</a></li>
                          <li><a href="index-4.html">Home Layout 3</a></li>
                          <li><a href="index-5.html">Home Layout 4</a></li>
                          <li><a href="index-6.html">Home Layout 5</a></li>
                          <li><a href="index-7.html">Home Layout 6</a></li>
                        </ul>
                      </li>
                      <li><a href="index-3.html">Home Layout 2</a></li>
                      <li><a href="index-4.html">Home Layout 3</a></li>
                  ...
                  <li class="static">
                    ...
                    <ul class="mega-menu mega-menu-2-col">
                      ...
                      <li class="d-none d-lg-block">
                        <div class="menu-banner-wrapper p-rel">
                          <a class="w-img" href="shop.html">
                            <img src="assets/ui/img/banner/menu/banner-women.jpg" alt="">
                          </a>
                      ...
                      <li class="d-none d-xl-block">
                        <div class="menu-banner-wrapper p-rel">
                          <a class="w-img" href="shop.html">
                            <img src="assets/ui/img/banner/menu/banner-men.jpg" alt="">
                          </a>
                    ...
                    <ul class="mega-menu mega-full mega-menu-3-col">
                      <li class="has-dropdown">
                        ...
                        <ul class="has-dropdown">
                          ...
                          <li><a href="product-details.html">Advance Product Type <span
                                class="menu-tag red">Hot</span></a></li>
                        </ul>
                      </li>
                      <li class="has-dropdown">
                      ...
                      <li class="has-dropdown">
                        ...
                        <ul class="has-dropdown">
                          ...
                          <li><a href="product-details.html">Swatch Simple <span class="menu-tag red">Hot</span></a>
                          </li>
                          <li><a href="product-details.html">Swatch Simple Color <span
                                class="menu-tag red">Hot</span></a></li>
                        </ul>
                      </li>
                    </ul>
            ...
            <div class="header-right-wrapper d-flex align-items-center justify-content-end">
              <div class="header-right header-right-2 d-flex align-items-center justify-content-end">
                ...
                <div class="header-icon header-icon-2 d-inline-block ml-30">
                  ...
                  <a href="auth/" class="d-none d-xl-inline-block"><i
            ...
            <div class="cartmini__list">
              <ul>
                <li class="cartmini__item p-rel d-flex align-items-start">
                  <div class="cartmini__thumb mr-15">
                    <a href="product-details.html">
                      <img src="assets/ui/img/products/product-1.jpg" alt="">
                    </a>
                  </div>
                ...
                <li class="cartmini__item p-rel d-flex align-items-start">
                  <div class="cartmini__thumb mr-15">
                    <a href="product-details.html">
                      <img src="assets/ui/img/products/product-2.jpg" alt="">
                    </a>
                  </div>
                  <div class="cartmini__content">
                    <h3 class="cartmini__title">
                ...
                <li class="cartmini__item p-rel d-flex align-items-start">
                  <div class="cartmini__thumb mr-15">
                    <a href="product-details.html">
                      <img src="assets/ui/img/products/product-3.jpg" alt="">
                    </a>
                  </div>
                  <div class="cartmini__content">
                    <h3 class="cartmini__title">
        ...
        <div class="modal-content">
          <div class="offcanvas__wrapper">
            <div class="offcanvas__top d-flex align-items-center mb-60 justify-content-between">
              <div class="logo">
                <a href="index-2.html">
                  <img src="assets/ui/img/logo/logo-black.png" alt="logo">
                </a>
              </div>
  ...
  <main>
    ...
    <section class="slider-area-rel">
      <div class="slider-active dot-style dot-style-1 dot-bottom-center">
        <div class="single-slider single-slider-2 default-bg slider-height-2 d-flex align-items-center"
          data-background="assets/ui/img/slider/slider-4.jpg">
          <div class="container container-2">
            <div class="row align-items-center">
              <div class="col-xxl-6 col-xl-6 col-lg-8 col-md-8 pt-60 pb-10 pt-md-0 pb-md-0">
                <div class="slider-content-2">
                  <span class="s-subtitle s-subtitle-3 pb-25" data-animation="fadeInUp" data-delay=".3s"> Featured
                    Products</span>
                  <h2 class="s-title s-title-2 pb-28" data-animation="fadeInUp" data-delay=".5s">Lamp Collection</h2>
                  <p class="s-desc pb-75" data-animation="fadeInUp" data-delay=".7s">Form is designed by Puik Store and
                    is part of the Form series. It is an <br>
        ...
        <div class="single-slider single-slider-2 default-bg slider-height-2 d-flex align-items-center"
          data-background="assets/ui/img/slider/slider-5.jpg">
          <div class="container container-2">
            <div class="row align-items-center">
              <div class="col-xxl-6 col-xl-6 col-lg-8 col-md-8 pt-60 pb-10 pt-md-0 pb-md-0">
                <div class="slider-content-2">
                  <span class="s-subtitle s-subtitle-3 pb-25" data-animation="fadeInUp" data-delay=".3s"> Top Sale Of
                    The Month</span>
        ...
        <div class="single-slider single-slider-2 default-bg slider-height-2 d-flex align-items-center"
          data-background="assets/ui/img/slider/slider-6.jpg">
          <div class="container container-2">
            <div class="row align-items-center">
              <div class="col-xxl-6 col-xl-6 col-lg-8 col-md-8 pt-60 pb-10 pt-md-0 pb-md-0">
                <div class="slider-content-2">
                  <span class="s-subtitle s-subtitle-3 pb-25" data-animation="fadeInUp" data-delay=".3s"> Hot Deal Off
                    The Day</span>
      ...
      <div class="row row-3">
          ...
          <a href="shop.html">
            <div class="single-category mb-20 p-rel wow fadeInUp" data-wow-delay=".3s">
              <div class="cat-thumb fix">
                <img src="assets/ui/img/category/home2/category-1.jpg" alt="#">
              </div>
              <div class="cat-content p-abs bottom-left">
                <h4 class="pb-15">Chair Collection SS/21</h4>
                <span class="cat-subtitle">18 Products</span>
              </div>
            </div>
          </a>
        </div>
        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-12">
          <a href="shop.html">
            <div class="single-category mb-20 p-rel wow fadeInUp" data-wow-delay=".3s">
              <div class="cat-thumb fix">
                <img src="assets/ui/img/category/home2/category-2.jpg" alt="#">
              </div>
              <div class="cat-content p-abs bottom-left">
                <h4 class="pb-15">Accessories Style</h4>
                <span class="cat-subtitle">12 Products</span>
              </div>
            </div>
          </a>
        </div>
        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-12">
          <a href="shop.html">
            <div class="single-category mb-20 p-rel wow fadeInUp" data-wow-delay=".3s">
              <div class="cat-thumb fix">
                <img src="assets/ui/img/category/home2/category-3.jpg" alt="#">
              </div>
              <div class="cat-content p-abs bottom-left">
                <h4 class="pb-15">Lighting Style SS/21</h4>
                <span class="cat-subtitle">18 Products</span>
              </div>
            </div>
          </a>
        ...
        <div class="row pb-20">
          <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="single-product mb-15 wow fadeInUp" data-wow-delay=".1s">
              <div class="product-thumb">
                <img src="assets/ui/img/products/furniture/1.jpg" alt="#">
                <img src="assets/ui/img/products/furniture/1-1.jpg" alt="#">
          ...
          <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="single-product mb-15 wow fadeInUp" data-wow-delay=".3s">
              <div class="product-thumb">
                <img src="assets/ui/img/products/furniture/2.jpg" alt="#">
                <img src="assets/ui/img/products/furniture/2-1.html" alt="#">
                <div class="cart-btn cart-btn-1 p-abs">
                  <a href="#">Add to cart</a>
                </div>
          ...
          <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="single-product mb-15 wow fadeInUp" data-wow-delay=".6s">
              <div class="product-thumb">
                <img src="assets/ui/img/products/furniture/3.jpg" alt="#">
                <img src="assets/ui/img/products/furniture/3-1.jpg" alt="#">
                <div class="cart-btn cart-btn-1 p-abs">
                  <a href="#">Add to cart</a>
                </div>
                <div class="product-action product-action-1 p-abs">
          ...
          <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="single-product mb-15 wow fadeInUp" data-wow-delay=".9s">
              <div class="product-thumb">
                <img src="assets/ui/img/products/furniture/4.jpg" alt="#">
                <img src="assets/ui/img/products/furniture/4-1.jpg" alt="#">
                <div class="cart-btn cart-btn-1 p-abs">
                  <a href="#">Add to cart</a>
                </div>
          ...
          <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="single-product mb-15 wow fadeInUp" data-wow-delay=".1s">
              <div class="product-thumb">
                <img src="assets/ui/img/products/furniture/5.jpg" alt="#">
                <img src="assets/ui/img/products/furniture/5-1.jpg" alt="#">
                <div class="cart-btn cart-btn-1 p-abs">
                  <a href="#">Add to cart</a>
                </div>
                <span class="discount discount-2 p-abs">New</span>
          ...
          <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="single-product mb-15 wow fadeInUp" data-wow-delay=".3s">
              <div class="product-thumb">
                <img src="assets/ui/img/products/furniture/6.jpg" alt="#">
                <img src="assets/ui/img/products/furniture/6-1.html" alt="#">
                <div class="cart-btn cart-btn-1 p-abs">
                  <a href="#">Add to cart</a>
                </div>
                <div class="product-action product-action-1 p-abs">
          ...
          <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="single-product mb-15 wow fadeInUp" data-wow-delay=".6s">
              <div class="product-thumb">
                <img src="assets/ui/img/products/furniture/7.jpg" alt="#">
                <img src="assets/ui/img/products/furniture/7-1.html" alt="#">
                <div class="cart-btn cart-btn-1 p-abs">
                  <a href="#">Add to cart</a>
                </div>
          ...
          <div class="col-xxl-3 col-xl-3 col-lg-4 col-md-6 col-sm-6">
            <div class="single-product mb-15 wow fadeInUp" data-wow-delay=".9s">
              <div class="product-thumb">
                <img src="assets/ui/img/products/furniture/8.jpg" alt="#">
                <img src="assets/ui/img/products/furniture/8-1.jpg" alt="#">
                <div class="cart-btn cart-btn-1 p-abs">
                  <a href="#">Add to cart</a>
                </div>
                <div class="product-action product-action-1 p-abs">
        ...
        <div class="row">
          ...
          <div class="col-xxl-6 col-lg-6 col-md-6 pe-0">
            <div class="single-banner single-banner-2 p-rel fix wow fadeInRight" data-wow-delay=".15s">
              <div class="thumb ">
                <img src="assets/ui/img/banner/banner-4.jpg" class=" wow fadeInRLeft h-100" data-wow-delay=".10s" alt="#">
              </div>
        ...
        <div class="row">
          <div class="col-xxl-12">
            <div class="section-title text-center pb-47">
              ...
              <p class="p-desc">Commodo sociosqu venenatis cras dolor sagittis integer luctus sem primis eget maecenas.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="col-xxl-12">
            <div class="top-selling-active-2 owl-carousel">
              <div class="single-product mb-15 wow fadeInUp" data-wow-delay=".1s">
                ...
                <div class="product-content">
                  <h4 class="pro-title pro-title-2"><a href="product-details.html">Simple Stylish Women Backpack</a>
                  </h4>
                  <div class="pro-price">
                    <span>£1.296.00</span>
                  </div>
              ...
              <div class="single-product mb-15 wow fadeInUp" data-wow-delay=".3s">
                <div class="product-thumb">
                  <img src="assets/ui/img/products/furniture/13.jpg" alt="#">
                  <img src="assets/ui/img/products/furniture/13-1.jpg" alt="#">
                  <div class="cart-btn cart-btn-2 p-abs">
                    <a href="#">Add to cart</a>
                  </div>
                  <span class="discount discount-2 p-abs">New</span>
              ...
              <div class="tab-content mb-10" id="productModalThumb">
                <div class="tab-pane fade show active" id="pro-1" role="tabpanel" aria-labelledby="pro-1-tab">
                  <div class="product__modal-thumb w-img">
                    <img src="assets/ui/img/products/modal/product-modal-1.jpg" alt="">
                  </div>
                </div>
                <div class="tab-pane fade" id="pro-2" role="tabpanel" aria-labelledby="pro-2-tab">
                  <div class="product__modal-thumb w-img">
                    <img src="assets/ui/img/products/modal/product-modal-2.jpg" alt="">
                  </div>
                </div>
                <div class="tab-pane fade" id="pro-3" role="tabpanel" aria-labelledby="pro-3-tab">
                  <div class="product__modal-thumb w-img">
                    <img src="assets/ui/img/products/modal/product-modal-3.jpg" alt="">
                  </div>
                </div>
                <div class="tab-pane fade" id="pro-4" role="tabpanel" aria-labelledby="pro-4-tab">
                  <div class="product__modal-thumb w-img">
                    <img src="assets/ui/img/products/modal/product-modal-4.jpg" alt="">
                  </div>
                </div>
              </div>
                ...
                <ul class="nav nav-tabs" id="productModalNav" role="tablist">
                  <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pro-1-tab" data-bs-toggle="tab" data-bs-target="#pro-1"
                      ...
                      <img src="assets/ui/img/products/modal/product-modal-sm-1.jpg" alt="">
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pro-2-tab" data-bs-toggle="tab" data-bs-target="#pro-2" type="button"
                      ...
                      <img src="assets/ui/img/products/modal/product-modal-sm-2.jpg" alt="">
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pro-3-tab" data-bs-toggle="tab" data-bs-target="#pro-3" type="button"
                      ...
                      <img src="assets/ui/img/products/modal/product-modal-sm-3.jpg" alt="">
                    </button>
                  </li>
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pro-4-tab" data-bs-toggle="tab" data-bs-target="#pro-4" type="button"
                      ...
                      <img src="assets/ui/img/products/modal/product-modal-sm-4.jpg" alt="">
                    </button>
                  </li>
                </ul>
              </div>
    ...
    <div class="subscribe-popup d-none">
      ...
      <div class="subscribe-thumb" data-background="assets/ui/img/popup/subscribe-bg.jpg"></div>
    </div>
    <!-- popup area end -->
  ...
  <script src="assets/ui/js/waypoints.min.js"></script>
  <script src="assets/ui/js/bootstrap.bundle.min.js"></script>
  <script src="assets/ui/js/tweenmax.js"></script>
  <script src="assets/ui/js/owl.carousel.min.js"></script>
  <script src="assets/ui/js/slick.min.js"></script>
  <script src="assets/ui/js/jquery-ui-slider-range.js"></script>
  <script src="assets/ui/js/jquery.meanmenu.min.js"></script>
  <script src="assets/ui/js/isotope.pkgd.min.js"></script>
  <script src="assets/ui/js/wow.min.js"></script>
  <script src="assets/ui/js/jquery.scrollUp.min.js"></script>
  <script src="assets/ui/js/countdown.min.js"></script>
  <script src="assets/ui/js/jquery.magnific-popup.min.js"></script>
  <script src="assets/ui/js/parallex.js"></script>
  <script src="assets/ui/js/imagesloaded.pkgd.min.js"></script>
  <script src="assets/ui/js/jquery.nice-select.min.js"></script>
  <script src="assets/ui/js/main.js"></script>
</body>


<!-- Mirrored from wphix.com/template/puik-prev/puik/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 06 Oct 2024 15:43:32 GMT -->
</html>